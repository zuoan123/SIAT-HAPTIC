...
set(gca,'XTick',1:9,...                                    
        'XTickLabel',{'Meshes','Stones','Glossy','Wood','Rubbers','Fibers','Foams','Foils','Fabrics'},...  %#   and tick labels
        'YTick',1:9,...                                    %同上
        'YTickLabel',{'Meshes','Stones','Glossy','Wood','Rubbers','Fibers','Foams','Foils','Fabrics'},...
        'TickLength',[0 0]);
