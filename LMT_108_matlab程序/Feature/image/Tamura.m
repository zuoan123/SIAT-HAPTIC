...
%
function [Fcoarseness,Fcontrast,Fdirection] = Tamura(im)
%im=imread('C:\Users\Administrator\Desktop\TUMÊý¾Ý¼¯\LMT_108_SurfaceMaterials_Database\ImageScans\NoFlash\Training\G3CeramicTile_Image_5_train6.jpg')

% Input image
I = rgb2gray(im);%Converts RGB image to grayscale
